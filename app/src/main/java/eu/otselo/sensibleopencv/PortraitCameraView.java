package eu.otselo.sensibleopencv;
...
public class PortraitCameraView extends CameraBridgeViewBase implements Camera.PreviewCallback {
    ...
    private static final String TAG = PortraitCameraView.class.getName();
    ...
    private class JavaCameraFrame implements CvCameraViewFrame {
        ...
        public Mat gray() {
            ...
            mRotated = mYuvFrameData.submat(0, mWidth, 0, mHeight); //submat with reversed width and height because it is applied on the landscape frame
            mRotated = mRotated.t();
